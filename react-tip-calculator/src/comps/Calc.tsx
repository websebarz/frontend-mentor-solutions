...
function Calc() {
  ...
  return (
    <div className="flex-container">
      ...
      <div className="tip-selector--el">
        <p className="text--el">Selec tip %</p>
        <div className="grid-container--el">
          {buttons.map((item, index) => {
            return (
              <button
                key={index}
                type="button"
                className="tip-perc--el"
      ...
      <div className="input-container--el">
        <label className="label-secondary--el">
          Number of People
          <br />
          <span className="people--el">
